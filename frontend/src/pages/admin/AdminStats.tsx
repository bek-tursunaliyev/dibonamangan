...
export default function AdminStats() {
  ...
  const cards = [
    { label: 'Foydalanuvchilar', value: stats.usersCount, icon: '👥' },
    { label: 'Faol mahsulotlar', value: stats.productsCount, icon: '💻' },
    { label: "Kutilayotgan e'lonlar", value: stats.pendingCount, icon: '⏳' },
    { label: 'AI so’rovlari', value: stats.quizCount, icon: '🤖' },
  ]
